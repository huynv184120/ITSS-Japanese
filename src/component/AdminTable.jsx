    ...
    return (
        <div className="container mx-auto mt-32 flex">
            <div className="button-group">
                ...
                <input class="shadow appearance-none border mb-1 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Location" onChange={event => setLocation(event.target.value)}/>
                ...
                <input class="shadow appearance-none border mb-1 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Free Time" onChange={event => setTime(event.target.value)}/>
